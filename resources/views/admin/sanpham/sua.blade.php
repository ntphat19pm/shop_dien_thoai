...
@section('content')
 ...
 <div class="mb-3">
 <label class="form-label" for="ram_id">Loại sản phẩm</label>
 ...
 <img class="d-block rounded" src="{{url('storage/app')}}/{{ $sanpham->LoaiSanPham->tenloai_slug }}/{{ $sanpham->hinhanh }}" width="100" />
